...
#define kDefaultInnerPadding	1
#define kDefaultHoleRadius		2
#define kDefaultTagLength		05
#define kDefaultTextPadding		00
#define kDefaultRadius			8
#define kDefaultTextColor		[UIColor whiteColor]
#define kDefaultFont			[UIFont systemFontOfSize:10]
