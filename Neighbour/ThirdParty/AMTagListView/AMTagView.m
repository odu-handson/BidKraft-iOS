...
+ (void)initialize
{
    ...
    [[self appearance] setHoleRadius:0];
...
//    float radius = self.radius;
    ...
    if (padding > 0) {
        UIBezierPath *aPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, width, height) cornerRadius:10];
...
//        [aPath addArcWithCenter:(CGPoint){tagLength + radius, radius} radius:radius startAngle:DEGREES_TO_RADIANS(0) endAngle:DEGREES_TO_RADIANS(270) clockwise:NO];
